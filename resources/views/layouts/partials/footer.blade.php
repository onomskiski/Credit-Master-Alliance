...
{{-- <div class='w-full py-5 px-4 md:px-8 bg-sky-700 shadow-lg text-sky-50 text-md border-t-2 border-t-gray-300'>
    <div class='flex flex-col space-y-5'>
        
        <div class='w-full flex justify-center flex-col md:flex-row md:space-x-10'>
            <div class='px-3 md:px-7 py-3'>
                <h3 class='font-bold text-2xl mb-3s text-white uppercase'>
                    who are we
                </h3>
            ...
            <div class='px-3 md:px-7 py-3'>
                ...
                <div class='flex items-center text-3xl space-x-3'>
                    <a href="#" className='pr-5'>
                        <div className='text-sky-50 py-2 text-lg flex justify-start hover:text-white cursor-pointer items-center'>
        ...
        <div class='border-t-2 border-t-sky-700'>
            <div class='my-4'>
                <div class='text-sm text-center'>
                    <div class='flex space-x-10 justify-center flex-wrap'>
                        <span class="">
                            Terms Of Use
                        </span>
                    ...
                    <div class="font-bold mt-4">
                        @2024 Credit Master Alliance, LLC.  All rights reserved.
                    </div>
                </div>
            </div>
        </div>
