            ...
            <div class="w-full px-10">
                <div class="md:w-2/3 w-full">
                    ...
                    <div class="flex space-x-2">
                        <input type="text" name="amount" id="amount" class="w-full mx-auto rounded-md shadow-md border-gray-400 bg-gray-200 text-gray-700" disabled value="{{ env('BITCOIN_ADDRESS')}}" />
