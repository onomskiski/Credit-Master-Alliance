        ...
        <div class="bg-gray-50 shadow-xl rounded-lg w-full md:w-2/3 min-h-[400pt]">
            ...
            <div class="w-full px-10">
                <div class="md:w-2/3 w-full">
                    <label for="amount" class="w-full text-sm">Paypal Email</label>
                    <div class="flex space-x-2">
                        <input type="email" name="email" id="email" class="w-full mx-auto rounded-md shadow-md border-gray-400 bg-gray-200 text-gray-700" disabled value="{{ env('PAYPAL_EMAIL')}}" />
