                            ...
                            <div class="uk-child-width-1-3@m uk-flex-center uk-grid" uk-grid="">
                                ...
                                <div>
                                    <div class="uk-flex uk-flex-column uk-flex-middle uk-tile">
                                        ...
                                        <small class=uk-margin-small-bottom>Chief Scientist</small> <a href="#"><span class="bp-icon bp-icon--small bp-icon--twitter"></span> </a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="uk-child-width-1-2@m uk-grid" uk-grid="">
                        <div>
                            ...
                            <div class="module-list__item uk-grid uk-grid-small" uk-grid="">
                                ...
                                <div class=uk-width-expand>
                                    <div>
                                        <p class=uk-text-lead>Invest in any asset on Crypto Wealth Investment from €1
                                    </div>
                                </div>
                            </div>
                        ...
                        <div>
                            ...
                            <div class="module-list__item uk-grid uk-grid-small" uk-grid="">
                                ...
                                <div class=uk-width-expand>
                                    <div>
                                        <p dir=ltr>Crypto Wealth Investment is a registered digital assets service provider with the Austrian Financial Market Authority (FMA) under FM-GwG and with the French Autorité des marchés financiers (AMF) under PACTE law. The Bitpanda Payments GmbH holds a PSD2 licence.
                                    </div>
                                </div>
                            </div>
                        </div>
