@include('layouts.partials.header')
    ...
    <section id=layout-content tabindex=-1>
        ...
        <div class="w-full lg:w-[50%] mx-auto my-10 flex flex-col items-center px-6 py-2">
            <div class="w-full text-center">
                <h2 class="font-bold text-2xl md:text-4xl text-green-600">
            ...
            <div class="w-full border-[1.5pt] border-green-600 rounded-lg" id="slidesdom">
                {{-- slides --}}
                <div class="full px-7 py-5">
                    <div class="w-full mb-8">
                        <h4 class="text-2xl font-bold text-green-600 text-center">
                            Here's how we do it
                        </h4>
                    </div>
                    ...
                    <div class="w-full flex justify-between space-y-5 md:space-x-5 md:space-y-0 items-center flex-col md:flex-row">
                        ...
                        <div class="slide-indicators flex justify-center items-center flex-row md:flex-col md:space-y-2 md:space-x-0 space-x-2">
                            <div onclick="prevSlide()" class="cursor-pointer text-xs italic text-green-600 font-bold">
                            ...
                            <div onclick="switchActiveSlide(2)" class="slide-indicator-2 cursor-pointer md:h-6 md:w-3 h-3 w-6 rounded-full bg-transparent border-green-600 border-2"></div>
                            <div onclick="switchActiveSlide(3)" class="slide-indicator-3 cursor-pointer md:h-6 md:w-3 h-3 w-6 rounded-full bg-transparent border-green-600 border-2"></div>

                            <div onclick="nextSlide()" class="cursor-pointer text-xs italic text-green-600 font-bold">
                        ...
                        <div class="relative w-full h-full min-h-[400pt] md:min-h-[200pt] overflow-hidden">
                            <div class="p-2 w-full min-h-[400pt] md:min-h-[200pt] absolute z-auto active-slide slide-1">
                                <div class="flex flex-col md:flex-row justify-between items-center w-full">
                                    <div class="px-5 py-5">
                                        <div class="rounded-full text-4xl font-bold text-green-600 border-green-600 border-[2pt] h-[50pt] w-[50pt] flex justify-center items-center">
                                            1
                                        </div>
                                    </div>
                                    ...
                                    <div class="w-full flex flex-col space-y-4 text-center md:text-left">
                                        ...
                                        Firstly, we'll carefully examine your credit reports, partnering with you to identify any suspicious negative items that may be inaccurately affecting your credit standing.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="p-2 w-full min-h-[400pt] md:min-h-[200pt]  absolute z-0 hidden-slide slide-2">
                                <div class="flex flex-col md:flex-row justify-between items-center w-full">
                                    ...
                                    <div class="w-full flex flex-col space-y-4 text-center md:text-left">
                                        ...
                                        <p class="text-md md:text-lg pr-3">
                                        Following that, we'll proceed to issue challenges on your behalf to both the credit bureaus and your creditors. Should they fail to verify the accuracy, fairness, and substantiation of these items, they are obligated to remove them from your credit report.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="p-2 w-full min-h-[400pt] md:min-h-[200pt] absolute z-0 hidden-slide slide-3">
                                <div class="flex flex-col md:flex-row justify-between items-center w-full">
                                    ...
                                    <div class="w-full flex flex-col space-y-4 text-center md:text-left">
                                        ...
                                        <p class="text-md md:text-lg pr-3">
                                        Ultimately, as we address each of your questionable negative items, we'll also assist you in cultivating intelligent credit practices to sustain and improve your credit standing in the future.
                                        </p>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="w-full bg-green-600 text-white py-[50pt] px-5">
            <div class="md:w-[70%] mx-auto md:py-[100pt]">
                ...
                <div class="flex justify-between flex-col md:flex-row w-full items-center mt-10">
                    <div class="flex flex-col space-y-3 items-center py-10 w-full">
                        ...
                        <div class="px-6">
                            <button class="bg-red-500 text-white px-4 md:px-8 py-3.5 text-sm font-[450]">
                                Get credit help
                            </button>
                        </div>
                    </div>
    
                    <div class="flex flex-col space-y-3 items-center py-10 border-t-2 border-t-red-500 md:border-t-0 md:border-l-2 md:border-l-red-500 w-full">
                        <p class="text-lg">
    ...
    <div class="w-full px-5 md:px-[30%] py-[20pt] flex flex-col justify-center items-center">
        ...
        <div class="w-full text-center">
            <h2 class="font-[450] text-2xl md:text-4xl text-green-600 my-4">
        ...
        <div class="text-center w-full">
            <h2 class="font-[450] text-2xl md:text-4xl text-green-600 my-4">First, we need some info to pull your credit</h2>
            <p>
        ...
        <div class="flex flex-col justify-center items-center w-full">
            ...
            <form>
                ...
                <div class="w-full flex justify-center items-center my-5">
                    <button type="submit" class="bg-red-500 px-12 py-3 hover:bg-accent-100/0 text-white hover:text-red-600 transition">
                        Submit
                    </button>
                </div>

                <div>
                    <p class="text-xs text-gray-800 text-justify-left">
                    By clicking "Submit," I electronically agree to the following terms: 1. I consent to being contacted by Creditmasteralliance.com regarding credit repair or credit repair marketing through live agents, artificial or prerecorded voice calls, and SMS texts at my residential or cellular number, whether dialed manually or through an autodialer, even if my number is registered on a do-not-call registry (acknowledging that consent to be contacted is not a requirement for purchasing services), and 2. I accept the Privacy Policy and Terms of Use (including this arbitration provision).
                    </p>
                </div>
            </form>
        </div>
    ...
    <div class="w-full flex flex-col md:flex-row bg-green-600 text-blue-50 my-4 items-center">

        <div class="w-full md:w-1/2 min-h-full">
          <img src="/resources/about-us/images/avery-evans-RJQE64NmC_o-unsplash.jpg" alt="mm" class="h-[100%] min-h-[400pt] w-full bg-gray-300">
        </div>
          ...
          {{-- text-block --}}
            ...
            <div class="flex space-y-4 flex-col text-center md:text-left items-center justify-center md:items-start md:justify-start">
                ...
                <p class="text-4xl md:text-5xl font-bold pt-10 pb-7 leading-relaxed">
                    <span class="font-bold text-[50pt] md:text-[55pt]">6,000</span> 
                    members
                </p>
                <p class="text-xl font-bold md:text-3xl">
                    with their credit since 2020
                </p>
            </div>
        </div>
